...
})(["display:grid;grid-gap:4rem;grid-template-columns:repeat(auto-fit,minmax(30%,1fr));"]);
  ...
  _createClass(OrderList, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        console.log(orders);
        return external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "You have ", orders.length, " orders"), external_react_default.a.createElement(OrderUI, null, orders.map(function (order) {
...
var orders_OrderPage = function OrderPage(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(SigninWrapper["a" /* default */], null, external_react_default.a.createElement(components_OrderList, null)));
};
