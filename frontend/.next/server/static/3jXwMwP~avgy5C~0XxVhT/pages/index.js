...
var ADD_TO_CART_MUTATION = external_graphql_tag_default()(_templateObject());
...
function DeleteItem_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { DeleteItem_typeof = function _typeof(obj) { return typeof obj; }; } else { DeleteItem_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return DeleteItem_typeof(obj); }

function DeleteItem_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function DeleteItem_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function DeleteItem_createClass(Constructor, protoProps, staticProps) { if (protoProps) DeleteItem_defineProperties(Constructor.prototype, protoProps); if (staticProps) DeleteItem_defineProperties(Constructor, staticProps); return Constructor; }

function DeleteItem_possibleConstructorReturn(self, call) { if (call && (DeleteItem_typeof(call) === "object" || typeof call === "function")) { return call; } return DeleteItem_assertThisInitialized(self); }

function DeleteItem_getPrototypeOf(o) { DeleteItem_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return DeleteItem_getPrototypeOf(o); }

function DeleteItem_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) DeleteItem_setPrototypeOf(subClass, superClass); }

function DeleteItem_setPrototypeOf(o, p) { DeleteItem_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return DeleteItem_setPrototypeOf(o, p); }

function DeleteItem_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function DeleteItem_templateObject() {
  var data = DeleteItem_taggedTemplateLiteral(["\n\tmutation DELETE_ITEM_MUTATION($id: ID!) {\n\t\tdeleteItem(id: $id) {\n\t\t\tid\n\t\t}\n\t}\n"]);

  DeleteItem_templateObject = function _templateObject() {
    return data;
  };
...
function DeleteItem_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }





var DELETE_ITEM_MUTATION = external_graphql_tag_default()(DeleteItem_templateObject());

var DeleteItem_DeleteItem =
/*#__PURE__*/
function (_Component) {
  DeleteItem_inherits(DeleteItem, _Component);
  ...
  function DeleteItem() {
    ...
    DeleteItem_classCallCheck(this, DeleteItem);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = DeleteItem_possibleConstructorReturn(this, (_getPrototypeOf2 = DeleteItem_getPrototypeOf(DeleteItem)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(DeleteItem_assertThisInitialized(DeleteItem_assertThisInitialized(_this)), "update", function (cache, payload) {
  ...
  DeleteItem_createClass(DeleteItem, [{
    key: "render",
    value: function render() {
      var _this2 = this;
...
var Pagination_Pagination = function Pagination(props) {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    var page = props.page;
    console.log(page);
    return external_react_default.a.createElement(styles_PaginationStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "CraftMonkey | - Page ", page, " of ", pages)), external_react_default.a.createElement(link_default.a, {
      prefetch: true,
      href: {
        pathname: 'items',
        query: {
...
var AlignCenter = external_styled_components_default.a.div.withConfig({
  displayName: "Items__AlignCenter",
...
function (_Component) {
  ...
  Items_createClass(Items, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(AlignCenter, null, external_react_default.a.createElement(components_Pagination, {
 ...
 //Using Render Props instead of Higher Order Components
// CONCATENATED MODULE: ./pages/index.js



var pages_Home = function Home(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(Items_Items, {
