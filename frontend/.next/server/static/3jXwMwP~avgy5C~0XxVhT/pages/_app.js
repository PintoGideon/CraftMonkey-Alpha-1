...
var prodEndPoint = " https://craftmonkey.herokuapp.com/";
var perPage = 4;
...
})(["background:#3a2e39;color:white;font-weight:500;border:0;border-radius:0;text-transform:uppercase;font-size:2rem;padding:0.8rem 1.5rem;transform:skew(-2deg);display:inline-block;transition:all 0.5s;&[disabled]{opacity:0.5;}"]);
...
})(["background:", ";color:", ";display:inline-block;padding:4px 5px;transform:skew(-3deg);margin:0;font-size:4rem;"], function (props) {
  return props.theme.red;
}, function (props) {
  return props.theme.bistre;
});
...
var DeleteButton = external_styled_components_default.a.button.withConfig({
  displayName: "RemoveFromCart__DeleteButton",
  componentId: "emvtd6-0"
})(["font-size:3rem;background:none;border:0;&:hover{color:", ";cursor:pointer;}"], function (props) {
  return props.theme.onyx;
});
...
function (_React$Component) {
  ...
  function RemoveFromCart() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "update", function (cache, payload) {
      ...
      var cartItemId = payload.data.removeFromCart.id; //Write it back to the cache
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        var loading = _ref.loading,
            error = _ref.error;
        return external_react_default.a.createElement(DeleteButton, {
          disabled: loading,
...
var CartItem_CartItem = function CartItem(_ref) {
  ...
  if (!cartItem.item) return external_react_default.a.createElement(CartItemStyles, null, external_react_default.a.createElement("p", null, "This item has been removed"));
...
// CONCATENATED MODULE: ./components/PaymentProcess.js


function PaymentProcess_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { PaymentProcess_typeof = function _typeof(obj) { return typeof obj; }; } else { PaymentProcess_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return PaymentProcess_typeof(obj); }

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function PaymentProcess_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function PaymentProcess_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function PaymentProcess_createClass(Constructor, protoProps, staticProps) { if (protoProps) PaymentProcess_defineProperties(Constructor.prototype, protoProps); if (staticProps) PaymentProcess_defineProperties(Constructor, staticProps); return Constructor; }

function PaymentProcess_possibleConstructorReturn(self, call) { if (call && (PaymentProcess_typeof(call) === "object" || typeof call === "function")) { return call; } return PaymentProcess_assertThisInitialized(self); }

function PaymentProcess_getPrototypeOf(o) { PaymentProcess_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return PaymentProcess_getPrototypeOf(o); }

function PaymentProcess_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) PaymentProcess_setPrototypeOf(subClass, superClass); }

function PaymentProcess_setPrototypeOf(o, p) { PaymentProcess_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return PaymentProcess_setPrototypeOf(o, p); }

function PaymentProcess_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function PaymentProcess_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function PaymentProcess_templateObject() {
  var data = PaymentProcess_taggedTemplateLiteral(["\n\tmutation createOrder($token: String!) {\n\t\tcreateOrder(token: $token) {\n\t\t\tid\n\t\t\tcharge\n\t\t\ttotal\n\t\t\titems {\n\t\t\t\tid\n\t\t\t\ttitle\n\t\t\t}\n\t\t}\n\t}\n"]);

  PaymentProcess_templateObject = function _templateObject() {
    return data;
  };
...
function PaymentProcess_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var CREATE_ORDER_MUTATION = external_graphql_tag_default()(PaymentProcess_templateObject());
...
var PaymentProcess_PaymentProcess =
/*#__PURE__*/
function (_React$Component) {
  PaymentProcess_inherits(PaymentProcess, _React$Component);
  ...
  function PaymentProcess() {
    ...
    PaymentProcess_classCallCheck(this, PaymentProcess);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = PaymentProcess_possibleConstructorReturn(this, (_getPrototypeOf2 = PaymentProcess_getPrototypeOf(PaymentProcess)).call.apply(_getPrototypeOf2, [this].concat(args)));

    PaymentProcess_defineProperty(PaymentProcess_assertThisInitialized(PaymentProcess_assertThisInitialized(_this)), "onToken",
    /*#__PURE__*/
    function () {
  ...
  PaymentProcess_createClass(PaymentProcess, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      ...
      return external_react_default.a.createElement(User["b" /* default */], null, function (_ref2) {
        ...
        return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
          ...
          return external_react_default.a.createElement(external_react_stripe_checkout_default.a, {
            ...
            stripeKey: "pk_test_ixxeFzsJoQ1uDx2ZB1QURfuJ00f1DTe34v",
            currency: "USD",
            email: me.email,
...
/* harmony default export */ var components_PaymentProcess = (PaymentProcess_PaymentProcess);
...
})(["position:relative;.count{display:block;position:relative;transition:all 0.4s;backface-visibility:hidden;}.count-center{transform:scale(4) rotateX(0.5turn);}.count-enter-active{transform:rotateX(0);}.count-exit-active{transform:scale(4) rotateX(0.5turn);}"]);
var TotalCount = external_styled_components_default.a.div.withConfig({
  displayName: "CartCount__TotalCount",
...
var CartCount_CartCount = function CartCount(_ref) {
  ...
  }, external_react_default.a.createElement(TotalCount, null, count))));
};
...
var Nav_Nav = function Nav() {
  return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
    ...
    return external_react_default.a.createElement(styles_NavStyles, {
      ...
      href: "/orders"
    }, external_react_default.a.createElement("a", null, "Orders")), external_react_default.a.createElement(components_Signout, null), external_react_default.a.createElement(external_react_apollo_["Mutation"], {
      mutation: TOGGLE_CART_MUTATION
    }, function (toggleCart) {
      return external_react_default.a.createElement("button", {
        onClick: toggleCart
  ...
  Search_createClass(AutoComplete, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(SearchStyles, null, external_react_default.a.createElement(external_downshift_default.a, {
        ...
        }), !_this2.state.items.length && !_this2.state.loading && external_react_default.a.createElement(DropDownItem, null, "No Item Found")));
      }));
    }
  }]);
...
})(["font-size:4rem;margin-left:2rem;position:relative;z-index:2;transform:skew(-7deg);a{font-family:'AlegreyaSans';padding:0.5rem 1rem;background:", ";color:white;text-transform:uppercase;text-decoration:none;}@media (max-width:1300px){margin:0;text-align:center;}"], function (props) {
  return props.theme.onyx;
});
...
var Header_Header = function Header() {
  return external_react_default.a.createElement(StyledHeader, null, external_react_default.a.createElement("div", {
    ...
    href: "/"
  }, external_react_default.a.createElement("a", null, "CraftMonkey"))), external_react_default.a.createElement(components_Nav, null)), external_react_default.a.createElement("div", {
    className: "sub-bar"
...
var Meta_Meta = function Meta() {
  ...
  }), external_react_default.a.createElement("title", null, "CraftMonkey"));
};
...
})(["max-width:1000px;margin:0 auto;padding:2rem;"]); //Global Stylings

Object(external_styled_components_["injectGlobal"])(Page_templateObject(), theme.bistre);
